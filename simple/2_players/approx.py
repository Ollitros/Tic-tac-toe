...
steps = []
for i in range(100):
    session_rewards = [generate_session(epsilon=epsilon, train=True, agent_1=agent_1, agent_2=agent_2, step=i) for _ in range(100)]

    rewards_1.append(session_rewards[0])
    rewards_2.append(session_rewards[1])

    print("epoch #{}\tmean reward = {:.3f}\tepsilon = {:.3f}\tAGENT".format(i, np.mean(rewards_1), epsilon), 1)
    print("epoch #{}\tmean reward = {:.3f}\tepsilon = {:.3f}\tAGENT".format(i, np.mean(rewards_2), epsilon), 2)
...
sessions = [generate_session(epsilon=epsilon, train=True, agent_1=agent_1, agent_2=agent_2, step=i) for _ in range(1000)]
